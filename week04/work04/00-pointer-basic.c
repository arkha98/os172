...
void main(void) {
	...
	printf("ptrptr3: ppt=%c, pts=%p, val=%p, adr=%p\n", **ptrptr3, *ptrptr3, ptrptr3, &ptrptr3);
        ...
        char*** ptrptrptr0=&ptrptr0;
        char*** ptrptrptr1=&ptrptr1;
        char*** ptrptrptr2=&ptrptr2;
        char*** ptrptrptr3=&ptrptr3;

        printf("ptrptrptr0: pppt=%c, ppt=%p, pts=%p, val=%p, adr=%p\n", ***ptrptrptr0, **ptrptr0, *ptrptr0, ptrptr0, &ptrptr0);
        printf("ptrptrptr1: pppt=%c, ppt=%p, pts=%p, val=%p, adr=%p\n", ***ptrptrptr1, **ptrptr1, *ptrptr1, ptrptr1, &ptrptr1);
        printf("ptrptrptr2: pppt=%c, ppt=%p, pts=%p, val=%p, adr=%p\n", ***ptrptrptr2, **ptrptr2, *ptrptr2, ptrptr2, &ptrptr2);
        printf("ptrptrptr3: pppt=%c, ppt=%p, pts=%p, val=%p, adr=%p\n", ***ptrptrptr3, **ptrptr3, *ptrptr3, ptrptr3, &ptrptr3);
}
